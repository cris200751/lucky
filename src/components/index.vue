<template>
  <div class="index">
    <div class="setting">
      ...
      <div class="main">
        ...
        <div class="list" id="imglist">
          <ul id="indexlist">
            <li @click="sportBooksClick = true">
              <img class="trans-up delay-10" src="../../static/images/1e.png" />
              <!--<p>SPORTSBOOK</p>-->
              <p v-if="sportBooksClick" class="comming-soon">Comming soon</p>
            </li>
            <li>
              <a href="http://alphatest.luckymeta.io?utm_source=tokenpocket"
                ><img
            ...
            <li @click="casinoClick = true">
              <img class="trans-up delay-20" src="../../static/images/3e.png" />
              <!--<p>casino</p>-->
              <p v-if="casinoClick" class="comming-soon">Comming soon</p>
            </li>
          </ul>
          <ul id="indexlist2">
            <li @click="liveCasinoClick = true">
              <img class="trans-up delay-05" src="../../static/images/4e.png" />
              <!--<p>LIVE CASINO</p>-->
              <p v-if="liveCasinoClick" class="comming-soon">Comming soon</p>
            </li>
            <li>
              <a href="http://alphatest.luckymeta.io?utm_source=tokenpocket">
                <img
            ...
            <li @click="socialGamesClick = true">
              <img class="trans-up delay-15" src="../../static/images/6e.png" />
              <!--<p>social games</p>-->
              <p v-if="socialGamesClick" class="comming-soon">Comming soon</p>
            </li>
          </ul>
    ...
    <div class="video">
      <h3 class="title">Introducing Lucky Meta</h3>
      <iframe
        width="1120"
        height="630"
        src="https://www.youtube.com/embed/4Gs_UyNXSaM"
...
export default {
  ...
  data() {
    return {
      ...
      active: -1,
      buyNowClick: false,
      marketPriceClick: false,
      sportBooksClick: false,
      casinoClick: false,
      liveCasinoClick: false,
      socialGamesClick: false,
    };
  },
  mounted() {
